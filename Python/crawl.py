...
def capture(output_file):
    ...
    while not finished:
        urls={}
        #'http://data.weibo.com/top/ajax/influence?page=%d&class=%d&type=day&depart=0001&level=0&open=&_t=0'
        data = {'page': 2, 'class': 29, 'type': 'day', 'depart': '0001',
                'level': 0, 'open': '', '_t': 0}        
        url = 'http://data.weibo.com/top/influence/famous?class=29&type=day'
