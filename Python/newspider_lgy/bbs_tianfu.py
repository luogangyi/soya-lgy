...
class TianFuLBBS(BaseBBS):
    ...
    def nextPage(self,keyword):
        try:
            ...
            items = soup.find("form",id="search-bar").findAll("input",attrs={'type':'hidden'})
...
if __name__ == "__main__":
    obj = TianFuLBBS(27)#Source_id defined in bbs_utils.py which is accroding the databse table keywords
    obj.main()
